...
public class AlbumService implements IAlbumService {
	...
	public EntityResult albumSongs(Map<String, Object> req) throws OntimizeJEERuntimeException {
		try {
			List<String> columns = Arrays.asList(AlbumDao.ATTR_TITLE,AlbumDao.ATTR_RELEASE_YEAR,SongDao.ATTR_NAME,SongDao.ATTR_DURATION, AlbumSongDao.ATTR_TRACK_NUMBER,ArtistDao.ATTR_NAME);
			Map<String,Object> filter = (Map<String, Object>) req.get("filter");
			...
			return this.daoHelper.query(this.albumDao, key, columns, "albumSongs");
