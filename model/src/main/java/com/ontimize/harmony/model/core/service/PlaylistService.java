...
public class PlaylistService implements IPlaylistService {
	...
	public EntityResult playlistSong(Map<String, Object> keyMap) throws OntimizeJEERuntimeException {
		try {
			List<String> columns = Arrays.asList(PlaylistDao.ATTR_NAME, PlaylistDao.ATTR_DESCRIPTION, PlaylistDao.ATTR_CREATION_DATE, SongDao.ATTR_NAME, SongDao.ATTR_DURATION, PlaylistSongDao.ATTR_TRACK_NUMBER);
